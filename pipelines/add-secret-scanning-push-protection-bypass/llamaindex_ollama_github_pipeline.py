...
class Pipeline:
    ...
    async def on_startup(self):
        ...
        Settings.embed_model = OllamaEmbedding(
            ...
            base_url="http://cleardiamondmedia.com:9999",
        )
        Settings.llm = Ollama(model="sin:latest")

        global index, documents

        github_token = os.environ.get("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")
