...
class Pipeline:
    ...
    def __init__(self):
        ...
        # Initialize
        self.valves = self.Valves(DB_HOST=os.getenv("DB_HOST", "localhost"),  # Database hostname
                                  ...
                                  TEXT_TO_SQL_MODEL=os.getenv("TEXT_TO_SQL_MODEL",
                                                              "llama3.1:latest"))  # Model to use for text-to-SQL generation
